...
int main()
{
  ...
  request_t test = {.page = 1, .type = "parts", .itemsPerPage = 30, .name="test", .orderName = 0, .orderId = 0, .orderAddedDate = asc, .orderLastModified = 0 };
    ...
    request_t test1 = {.page = 1, .type = "parts", .itemsPerPage = 30, .name="test12", .orderName = 0, .orderId = 0, .orderAddedDate = asc, .orderLastModified = 0, .category = "2", .id = "96"};
    request_t test2 = {.page = 1, .type = "parts", .itemsPerPage = 30, .name="test2", .orderName = 0, .orderId = 0, .orderAddedDate = asc, .orderLastModified = 0, .category = "2", .id = "95"};
